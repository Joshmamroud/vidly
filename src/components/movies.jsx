...
class Movies extends Component {
    ...
    getPagedData = () => {
        const { selectedGenre, sortColumn, movies: allMovies, currentPage, pageSize } = this.state;
        ...
        return (
            <div className="row">
                ...
                <div className="col">
                    ...
                    <Pagination itemsCount={movies.length} pageSize={pageSize} onPageChange={this.handlePageChange} currentPage={currentPage} />
                </div>
            </div>
        );
    }
